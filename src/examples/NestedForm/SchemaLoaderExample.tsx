  ...
  return (
    <Card style={{ marginTop: '20px', maxWidth: '800px' }}>
      ...
      <Callout intent="primary" style={{ marginBottom: '20px' }}>
        ...
        <p>
          This example demonstrates using <code>schemaLoader</code> to
          asynchronously load product configuration schemas from a server based
          on the selected product type.
        </p>
        <ul style={{ marginBottom: 0 }}>
          <li>Select a product type (Laptop, Smartphone, or Tablet)</li>
          <li>
            The configuration form will load asynchronously (simulated 800ms
            delay)
          </li>
