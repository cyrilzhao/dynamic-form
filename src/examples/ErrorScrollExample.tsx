  ...
  return (
    <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <p style={{ color: '#666', marginBottom: '20px' }}>
        This example demonstrates automatic scrolling to the first error field
        in array items. Try clicking "Validate" button to trigger validation -
        the page will automatically scroll to the first item with validation
        errors.
      </p>
      ...
      >
        <Tab
          ...
          panel={<NormalRenderingExample />}
        />
        <Tab
          id="virtual"
          title="Virtual Scroll"
          panel={<VirtualScrollExample />}
        />
      </Tabs>
    </div>
  )
  ...
  const schema: ExtendedJSONSchema = {
    ...
    properties: {
      users: {
        ...
        title: 'User List',
        description:
          'Scroll down and click "Validate" to see auto-scroll to error',
        items: {
          type: 'object',
          properties: {
            id: {
    ...
    <Card elevation={Elevation.TWO} style={{ marginTop: '20px' }}>
      <div style={{ marginBottom: '20px' }}>
        ...
        <p style={{ color: '#666', fontSize: '14px' }}>
          This mode renders all array items directly in the DOM. Suitable for
          arrays with fewer than 20 items.
        </p>
        <div
          style={{
            marginTop: '10px',
        ...
        >
          ...
          >
            ...
            <li>
              Notice that item #10 has empty required fields (name, email, age,
              role)
            </li>
            <li>Click the "Validate" button below</li>
            <li>
              The page will automatically scroll to item #10 (the first error)
            </li>
          </ol>
        </div>
      </div>
      ...
      <div style={{ marginTop: '20px', display: 'flex', gap: '10px' }}>
        ...
        <Button
          ...
          onClick={() =>
            formRef.current
              ?.validate()
              .then((isValid) => isValid && handleSubmit(formData))
          }
          large
        >
          Submit
  ...
  return (
    <Card elevation={Elevation.TWO} style={{ marginTop: '20px' }}>
      <div style={{ marginBottom: '20px' }}>
        ...
        <p style={{ color: '#666', fontSize: '14px' }}>
          This mode uses virtualization to render only visible items. Suitable
          for arrays with 20+ items. Provides better performance and smooth
          scrolling.
        </p>
        <div
          style={{
        ...
        >
          ...
          >
            <li>
              Notice there are 100 product items (scroll to see the count)
            </li>
            <li>
              Item #50 has empty required fields (name, sku, price, stock,
              category)
            </li>
            <li>Click the "Validate" button below</li>
            <li>
              The virtual scroll will automatically jump to item #50 (the first
              error)
            </li>
