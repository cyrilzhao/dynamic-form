...
const fetchActionsByCategory = async (
  category: string
    ...
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <Card>
        ...
        <p style={{ color: '#666', marginBottom: '20px' }}>
          This example demonstrates the new <strong>multiple linkages</strong>{' '}
          feature:
        </p>
        <ul style={{ color: '#666', marginBottom: '20px' }}>
          <li>
            Use <code>linkages</code> array to define multiple linkage rules for
            a single field
          </li>
          <li>
            When <code>category</code> changes, <code>action</code> field
            triggers two linkages simultaneously:
            <ul>
              <li>
                <strong>Value linkage</strong>: Clear the current value
              </li>
              <li>
                <strong>Options linkage</strong>: Load new options based on
                category
              </li>
            </ul>
          </li>
          <li>
            System automatically executes linkages in parallel and merges
            results
          </li>
      ...
      <Card style={{ marginTop: '20px' }}>
        ...
        <div style={{ color: '#666' }}>
          ...
          <ol>
            <li>
              <strong>Multiple Linkages Support:</strong> Use{' '}
              <code>linkages</code> array instead of single <code>linkage</code>{' '}
              object.
            </li>
            <li>
              <strong>Automatic Value Clearing:</strong> No need to manually
              call <code>form.setValue()</code> in linkage functions.
            </li>
            <li>
              <strong>Parallel Execution:</strong> All linkage rules execute in
              parallel using <code>Promise.allSettled</code>.
            </li>
            <li>
              <strong>Smart Result Merging:</strong>
              <ul>
                <li>
                  State types (visibility/disabled/readonly): Direct merge
                </li>
                <li>Value/options/schema types: Last-wins strategy</li>
              </ul>
            </li>
            <li>
              <strong>Backward Compatible:</strong> Single <code>linkage</code>{' '}
          ...
          <ul>
            <li>
              ✅ Cleaner configuration: No need to mix value clearing logic in
              options linkage function
            </li>
            <li>
              ✅ Better separation of concerns: Each linkage rule has a single
              responsibility
            </li>
            <li>
              ✅ No form ref required: Value clearing is declarative, not
              imperative
            </li>
            <li>
              ✅ More maintainable: Easy to add/remove/modify individual linkage
              rules
            </li>
          </ul>
