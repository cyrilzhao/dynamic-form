  ...
  return (
    <div>
      ...
      <Card style={{ marginTop: '20px' }}>
        ...
        <ul>
          <li>
            <strong>数组字段联动</strong>：<code>contacts</code>{' '}
            数组的显示/隐藏由 <code>showContacts</code> 字段控制
          </li>
          <li>
            <strong>数组元素内部联动</strong>：当 <code>type</code>{' '}
            为"工作"时，显示 <code>companyName</code> 和 <code>department</code>{' '}
            字段
          </li>
          <li>
            <strong>相对路径</strong>：使用 <code>./type</code>{' '}
            引用同一数组元素内的 <code>type</code> 字段
          </li>
          <li>
            <strong>操作步骤</strong>：
            <ol>
