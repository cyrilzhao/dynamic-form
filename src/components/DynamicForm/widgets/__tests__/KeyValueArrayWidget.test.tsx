...
describe("KeyValueArrayWidget", () => {
  ...
  describe("自定义标签", () => {
    it("应该显示自定义键值标签", () => {
      render(
        <FormWrapper
          defaultValues={{ mappings: [{ source: "a", target: "b" }] }}
        >
          <KeyValueArrayWidget
            name="mappings"
            schema={defaultSchema}
  ...
  describe("Widget 类型推断", () => {
    ...
    it("email format 应该使用 email widget", () => {
      ...
      render(
        <FormWrapper
          defaultValues={{
            mappings: [{ key: "a", value: "test@example.com" }],
          }}
        >
    ...
    it("uri format 应该使用 url widget", () => {
      ...
      render(
        <FormWrapper
          defaultValues={{
            mappings: [{ key: "a", value: "https://example.com" }],
          }}
        >
    ...
    it("enum 类型应该使用 select widget", () => {
      ...
      render(
        <FormWrapper
          defaultValues={{ mappings: [{ key: "a", value: "option1" }] }}
        >
    ...
    it("key 字段也应该支持 enum 类型", () => {
      ...
      render(
        <FormWrapper
          defaultValues={{ mappings: [{ key: "key1", value: "b" }] }}
        >
