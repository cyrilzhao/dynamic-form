...
describe("ArrayFieldWidget", () => {
  const simpleStringSchema: ExtendedJSONSchema & {
    type: "array";
  ...
  const objectItemSchema: ExtendedJSONSchema & {
    type: "array";
    items: ExtendedJSONSchema;
  } = {
    type: "array",
  ...
  const enumSchema: ExtendedJSONSchema & {
    type: "array";
    items: ExtendedJSONSchema;
  } = {
    type: "array",
  ...
  describe("不同类型的默认值", () => {
    it("添加 number 类型项时应该使用默认值 0", async () => {
      const numberSchema: ExtendedJSONSchema & {
        type: "array";
        items: ExtendedJSONSchema;
      } = {
        type: "array",
    ...
    it("添加 boolean 类型项时应该使用默认值 false", async () => {
      const booleanSchema: ExtendedJSONSchema & {
        type: "array";
        items: ExtendedJSONSchema;
      } = {
        type: "array",
    ...
    it("添加 integer 类型项时应该使用默认值 0", async () => {
      const integerSchema: ExtendedJSONSchema & {
        type: "array";
        items: ExtendedJSONSchema;
      } = {
        type: "array",
    ...
    it("添加带 autogenerate uuid 的项时应该生成 UUID", async () => {
      const uuidSchema: ExtendedJSONSchema & {
        type: "array";
        items: ExtendedJSONSchema;
      } = {
        type: "array",
    ...
    it("添加带 default 值的项时应该使用指定默认值", async () => {
      const schemaWithDefault: ExtendedJSONSchema & {
        type: "array";
        items: ExtendedJSONSchema;
      } = {
        type: "array",
  ...
  describe("对象类型数组", () => {
    it("添加对象类型项时应该生成各属性默认值", async () => {
      const complexObjectSchema: ExtendedJSONSchema & {
        type: "array";
        items: ExtendedJSONSchema;
      } = {
        type: "array",
    ...
    it("对象属性带 autogenerate uuid 时应该生成 UUID", async () => {
      const schemaWithUuidProp: ExtendedJSONSchema & {
        type: "array";
        items: ExtendedJSONSchema;
      } = {
        type: "array",
    ...
    it("对象属性带 default 值时应该使用指定默认值", async () => {
      const schemaWithDefaults: ExtendedJSONSchema & {
        type: "array";
        items: ExtendedJSONSchema;
      } = {
        type: "array",
