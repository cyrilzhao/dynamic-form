...
describe('ConditionEditor', () => {
      ...
      render(
        <ConditionEditor
          ...
          value={{
            and: [
              { field: '#/properties/age', operator: '>', value: '18' },
              { or: [{ field: '#/properties/name', operator: '==', value: 'test' }] },
            ],
          }}
        />
      );
  ...
  describe('in 和 notIn 操作符', () => {
    it('in 操作符应该显示数组输入', () => {
      render(
        <ConditionEditor
          {...defaultProps}
          value={{ field: '#/properties/age', operator: 'in', value: ['18', '20'] }}
        />
      );
    ...
    it('notIn 操作符应该显示数组输入', () => {
      render(
        <ConditionEditor
          {...defaultProps}
          value={{ field: '#/properties/age', operator: 'notIn', value: ['18'] }}
        />
      );
  ...
  describe('includes 和 notIncludes 操作符', () => {
    it('includes 操作符应该正确渲染', () => {
      render(
        <ConditionEditor
          {...defaultProps}
          value={{ field: '#/properties/name', operator: 'includes', value: 'test' }}
        />
      );
    ...
    it('notIncludes 操作符应该正确渲染', () => {
      render(
        <ConditionEditor
          {...defaultProps}
          value={{ field: '#/properties/name', operator: 'notIncludes', value: 'test' }}
        />
      );
  ...
  describe('比较操作符', () => {
    ...
    it('大于等于操作符应该正确渲染', () => {
      ...
      expect(screen.getByDisplayValue('Greater or Equal (>=)')).toBeInTheDocument();
    });
    ...
    it('嵌套对象路径应该正确处理', () => {
      ...
      render(
        <ConditionEditor
          ...
          dependencies={['#/properties/user/properties/profile/properties/name']}
          onChange={jest.fn()}
          value={{ field: '', operator: '==', value: '' }}
        />
      );
  ...
  describe('转换条件类型', () => {
    it('点击 Convert to AND 应该将单条件转换为 AND 组', () => {
      ...
      const moreButton = screen.getAllByRole('button').find(btn =>
        btn.querySelector('.bp5-icon-more')
      );
      if (moreButton) {
