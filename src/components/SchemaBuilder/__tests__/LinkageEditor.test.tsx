...
describe('LinkageEditor', () => {
  ...
  describe('无联动配置时', () => {
    ...
    it('应该显示提示信息', () => {
      render(<LinkageEditor {...defaultProps} />);
      expect(
        screen.getByText(/No linkage configured/i)
      ).toBeInTheDocument();
    });
  ...
  describe('有联动配置时', () => {
    ...
    it('应该显示联动配置面板', () => {
      render(
        <LinkageEditor {...defaultProps} value={linkageValue} />
      );
  ...
  describe('不同联动类型', () => {
    it('应该正确渲染 disabled 类型联动', () => {
      ...
      render(
        <LinkageEditor {...defaultProps} value={disabledLinkage} />
      );
      expect(screen.getByText('Linkage Configuration')).toBeInTheDocument();
    });
    ...
    it('应该正确渲染 readonly 类型联动', () => {
      ...
      render(
        <LinkageEditor {...defaultProps} value={readonlyLinkage} />
      );
      expect(screen.getByText('Linkage Configuration')).toBeInTheDocument();
    });
    ...
    it('应该正确渲染 value 类型联动', () => {
      ...
      render(
        <LinkageEditor {...defaultProps} value={valueLinkage} />
      );
      expect(screen.getByText('Linkage Configuration')).toBeInTheDocument();
    });
  });
  ...
  describe('options 类型联动', () => {
    it('应该正确渲染 options 类型联动', () => {
      ...
      render(
        <LinkageEditor {...defaultProps} value={optionsLinkage} />
      );
      expect(screen.getByText('Linkage Configuration')).toBeInTheDocument();
    });
  ...
  describe('schema 类型联动', () => {
    it('应该正确渲染 schema 类型联动', () => {
      ...
      render(
        <LinkageEditor {...defaultProps} value={schemaLinkage} />
      );
      expect(screen.getByText('Linkage Configuration')).toBeInTheDocument();
    });
